        ...
        for i, (x_real, c_org) in enumerate(data_loader):
            ...
            for idx, c_trg in enumerate(c_trg_list):
                ...
                with torch.no_grad():
                    ...
                    result_path = os.path.join('stargan_celeba_256/results_no_attack', '{}-{}-images.jpg'.format(i,idx))
                    save_image(gen_noattack.data.cpu(), result_path, nrow=1, padding=0)
                ...
                with torch.no_grad():
                    ...
                    result_path = os.path.join('stargan_celeba_256/results_attack', '{}-{}-images.jpg'.format(i,idx))
                    save_image(gen.data.cpu(), result_path, nrow=1, padding=0)
